...
var map = L.map("map").setView([-1.6535,-79.5217],14);
...
//-----------------------------------------------------------------------------------------------------
var via = L.geoJSON(via, {
											style	      : via_styles
});



var lotes = L.geoJSON(lotes, {
											style 		  : lotes_styles,
											onEachFeature : popuplotes
});



var cluster_puntoslote1 = L.markerClusterGroup();

var puntoslote1 = L.geoJSON(puntoslote1, {
															pointToLayer: function(feature, latlng){
																					return L.marker(latlng, {
																					})
																} 	
});
cluster_puntoslote1.addLayer(puntoslote1);
...
var layers		= {
					"via"						:   via,
					"lotes"						:   lotes,
					"puntoslote1"				:   cluster_puntoslote1 
